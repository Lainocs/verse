...
export default function Hero() {
  ...
  // scroll-scrubbed "console power-down" exit: the whole scene tilts back
  // and fades in 3D space as the hero scrolls out, instead of a flat slide
  useEffect(() => {
    const ctx = gsap.context(() => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="relative h-full w-full">
            <Image
              ...
              alt="Illustration tactique de Nicolas de Garrigues, pose agent en pied"
              fill
        ...
        <div
          ref={headlineRef}
          className="relative z-10 px-6 pb-20 md:px-10 md:pb-28"
        >
